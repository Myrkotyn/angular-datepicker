...
$templateCache.put('templates/datepicker.html',
    ...
    "        <tr>\n" +
    "          <td colspan=\"3\">\n" +
    "            <span ng-repeat=\"month in months\" ng-class=\"classes[$index]\" ng-click=\"selectDate(month)\" ng-bind=\"month|mFormat:'MMMM':tz\"></span>\n" +
    "          </td>\n" +
    "        </tr>\n" +
    "      </tbody>\n" +
    "    </table>\n" +
    ...
    "        <tr>\n" +
    "          <td colspan=\"7\">\n" +
    "            <span ng-repeat=\"hour in hours\" ng-class=\"classes[$index]\" ng-click=\"selectDate(hour)\" ng-bind=\"hour|mFormat:'HH:mm':tz\"></span>\n" +
    "          </td>\n" +
    "        </tr>\n" +
    "      </tbody>\n" +
    "    </table>\n" +
    ...
    "        <tr>\n" +
    "          <td colspan=\"7\">\n" +
    "            <span ng-repeat=\"minute in minutes\" ng-class=\"classes[$index]\" ng-click=\"selectDate(minute)\" ng-bind=\"minute|mFormat:'HH:mm':tz\"></span>\n" +
    "          </td>\n" +
    "        </tr>\n" +
    "      </tbody>\n" +
    "    </table>\n" +
